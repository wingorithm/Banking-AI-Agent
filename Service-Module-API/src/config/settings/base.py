...
class BackendBaseSettings(pydantic_settings.BaseSettings):
    ...
    DB_MILVUS_ALIAS: str = decouple.config("MILVUS_ALIAS", cast=str)
    DB_MILVUS_HOST: str = decouple.config("MILVUS_HOST", cast=str)
    DB_MILVUS_PORT: str = decouple.config("MILVUS_PORT", cast=str)
    DB_MILVUS_NAME: str = decouple.config("MILVUS_DB", cast=str)
    DB_MILVUS_PASSWORD: str = decouple.config("MILVUS_PASSWORD", cast=str)
    DB_MILVUS_USERNAME: str = decouple.config("MILVUS_USERNAME", cast=str)
