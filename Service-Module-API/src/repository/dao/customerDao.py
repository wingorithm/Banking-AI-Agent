...
from src.model.db.customer import Account
from src.model.schemas.customer import CustomerDTO
from src.repository.dao.base import BaseCRUDRepository
from src.util.exceptions.database import EntityAlreadyExists, EntityDoesNotExist
from src.util.exceptions.password import PasswordDoesNotMatch

# TODO: fix this dao adjust to Customer
